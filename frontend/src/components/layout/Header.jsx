    ...
    return (
        <header className="h-16 flex items-center justify-between px-4 sm:px-6 bg-glass backdrop-blur-md border-b border-black/5 dark:border-white/5 z-50 sticky top-0 transition-colors duration-500">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
                <Link to="/showcase" className="hidden sm:flex items-center px-3 py-1.5 text-xs font-semibold bg-[#f0f9ff] text-[#0284c7] border border-[#bae6fd] hover:bg-[#e0f2fe] rounded-full transition-colors">
                    Technical Showcase
                </Link>
                <LanguageSelector />
